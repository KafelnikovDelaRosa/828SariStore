   ...
   <center>
        ...
        <form action="<?php echo base_url('Remove')?>" method="post">
            <div class="form-group">
                <label for="inputnumber">Item Number</label>
                <input type="text" name="itemno" class="form-control" placeholder="Scan The Item" aria-describedby="helpId" autocomplete=off autofocus>
                <small id="helpId" class="text-muted"><?php echo form_error('itemno')?></small>
            </div>
            <input type="submit" value="Remove Item" name="submit"  class="btn btn-success"></input> 
        </form> 
    </center>
    <!-- Optional JavaScript --> <script>
