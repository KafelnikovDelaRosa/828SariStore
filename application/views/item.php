...
<html lang="en">
  ...
  <body>   
    ...
    <center>
        ...
        <br>
        <center>
        <form action="<?php echo base_url('Restock/item/'.$_SESSION['itemid'])?>"  method="post" enctype="multipart/form-data">
            <br><br>
            <h3>Item Information</h3>
            <div class="form-group">
                <label for="inputNames">Item Stock</label>
                <input type="number" class="form-control"  value="<?php echo set_value("stock");?>" name="stock" placeholder="Enter Stocks">
                <small id="error" style="color:red;" class="form-text"><?php echo form_error('stock') ?> </small>
            </div>
            <br>
            <input type="submit" value="Restock Item" name="submit"  class="btn btn-success"></input>
            <br><br>
        </form>
        <br><br>
    </center>
