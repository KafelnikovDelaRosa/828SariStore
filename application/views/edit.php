...
<html lang="en">
  ...
  <body>   
    ...
    <center>
        ...
        <br>
        <center>
        <form action="<?php echo base_url('Update/edit/'.$_SESSION['itemid'])?>"  method="post" enctype="multipart/form-data">
            <br><br>
            <h3>Item Information</h3>
           <div class="form-group">
                <label for="inputNames">Item Number</label>
                <input type="text" class="form-control" value="<?php echo $infodata[0]?>" name="itemno" readonly>  
                <small id="error" style="color:red;" class="form-text"><?php echo form_error('itemno') ?> </small>
            </div> 
            <div class="form-group">
                <label for="inputNames">Item Name</label>
                <input type="text" class="form-control" value="<?php echo $infodata[1]?>" name="name">
                <small id="error" style="color:red;" class="form-text"><?php echo form_error('name') ?> </small>
            </div> 
            <br>
            <div class="form-group">
                <label for="inputNames">Item Cost</label>
                <input type="number" class="form-control" value="<?php echo $infodata[2] ?>" name="cost">
                <small id="error" style="color:red;" class="form-text"><?php echo form_error('cost') ?> </small>
            </div>
            <br>
            <div class="form-group">
                <label for="inputNames">Item Stock</label>
                <input type="number" class="form-control"  value="<?php echo $infodata[3]?>" name="stock">
                <small id="error" style="color:red;" class="form-text"><?php echo form_error('stock') ?> </small>
            </div>
            <br>
            <input type="submit" value="Edit Item" name="submit"  class="btn btn-success"></input>
            <br><br>
        </form>
        <br><br>
    </center>
